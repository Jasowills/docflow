...
export class AppConfig {
  ...
  get azureSpeechRegion(): string {
    return this.configService.get<string>('AZURE_SPEECH_REGION', 'australiaeast');
  }
  ...
  get azureOpenAiDeploymentName(): string {
    return this.configService.get<string>('AZURE_OPENAI_DEPLOYMENT_NAME', 'gpt-4.1');
  }

  get azureOpenAiApiVersion(): string {
    return this.configService.get<string>('AZURE_OPENAI_API_VERSION', '2025-03-01-preview');
  }
